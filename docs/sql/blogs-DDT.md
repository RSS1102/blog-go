...
CREATE TABLE `blog_blogs` (
                              ...
                              `content_md` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '文章内容markdown',
                              `content_html` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '文章内容html',
                              `visitors` int NOT NULL DEFAULT '0' COMMENT '浏览量',
